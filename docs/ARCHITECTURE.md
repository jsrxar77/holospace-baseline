...
4. **SuperAdmin Global:** Solo el SuperAdmin autenticado (`superadmin@holospace.com.ar`) tiene bypass de RLS (`app.is_superadmin = true`) para labores de auditoría y gobierno multiplataforma.
